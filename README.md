...
![ALT pic](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-low_level_programming/228/printf.png "my pic")
...
- You might want to look at the gcc flag -Wno-format when testing with your _print and the standard printf
